                  ...
                  <tbody className="bg-white divide-y divide-gray-200 ">
                    {crafts.map((craft) => (
                      <tr key={craft._id}>
                        ...
                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                          {/* Complete Button */}
                         <Link to={`/viewDetails/${craft._id}`}> <button class="flex items-center px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
