...
const MyArt = () => {
  ...
  return (
    <div>
      ...
      <h1>total user add card: {user.length}</h1>
            ...
            <div>
              <div className="card h-[420px] card-compact  bg-base-100 shadow-xl">
                ...
                <div className="card-body">
                    <h2 className="card-title text-2xl font-bold">{p.itemName}</h2>
                    <div className="flex justify-between">
                      <p className="font-semibold text-xl">Price: { p.price}</p>
                      <p className="font-semibold text-xl">Rating: { p.rating}</p>
                    </div>
                    <div className="flex justify-between gap-3">
                      <p className="font-semibold text-xl">Customization: { p.customization}</p>
                      <p className="font-semibold text-xl">Stock_Status: <span >{ p.stockStatus}</span> </p>
                    </div>
